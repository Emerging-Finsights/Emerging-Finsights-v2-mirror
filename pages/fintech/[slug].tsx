...
type FintechArticlePageProps = {
    article: ArticleFull,
}

const FintechArticlePage: NextPage<FintechArticlePageProps> = props => {
    return (
        <Page>
            <Head>
...
export const getServerSideProps: GetServerSideProps<FintechArticlePageProps> = async ({ params }) => {
    ...
    if (!article || article.category != "fintech") return { notFound: true }

    /* pass props to article page */
    return { props: { article: article } }
}

export default FintechArticlePage;