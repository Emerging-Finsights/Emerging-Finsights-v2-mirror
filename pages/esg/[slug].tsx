...
type EsgArticlePageProps = {
    article: ArticleFull,
}

const EsgArticlePage: NextPage<EsgArticlePageProps> = props => {
    return (
        <Page>
            <Head>
...
export const getServerSideProps: GetServerSideProps<EsgArticlePageProps> = async ({ params }) => {
    ...
    if (!article || article.category != "esg") return { notFound: true }

    /* pass props to article page */
    return { props: { article: article } }
}

export default EsgArticlePage;